"""E2E diagnostic for exec retry under real network faults using nftables.

Uses nftables REJECT rules to kill an established websocket connection
mid-stream, then verifies that K8sSandboxEnvironment.exec() retries and
recovers (or fails without retry logic).
